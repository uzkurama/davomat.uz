...
<div class="col-md-6">
        <div class="card">
            ...
            <div class="card-content">
                    ...
                    <div class="col-lg-2">
                        <img src="<?= Yii::$app->request->baseUrl?>/admin/<?= $model->image?>">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label"><?= $model->getAttributeLabel(father_name);?></label>
                        <p type="text" class="form-control"><?= $model->father_name ?></p>
                    </div>
                    <div class="col-md-6">
                        <label class="control-label"><?= $model->getAttributeLabel(mother_name);?></label>
                        <p type="text" class="form-control"><?= $model->mother_name ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label"><?= $model->getAttributeLabel(father_post);?></label>
                        <p type="text" class="form-control"><?= $model->father_name ?></p>
                    </div>
                    <div class="col-md-6">
                        <label class="control-label"><?= $model->getAttributeLabel(mother_post);?></label>
                        <p type="text" class="form-control"><?= $model->mother_name ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label"><?= $model->getAttributeLabel(father_number);?></label>
                        <p type="text" class="form-control"><?= $model->father_name ?></p>
                    </div>
                    <div class="col-md-6">
                        <label class="control-label"><?= $model->getAttributeLabel(mother_number);?></label>
                        <p type="text" class="form-control"><?= $model->mother_name ?></p>
                    </div>
                </div>
            </div>
